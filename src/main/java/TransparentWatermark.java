...
public class TransparentWatermark {
    ...
    public static final String SRC = "/Users/haoliu350/Desktop/Timesheet.pdf";
    public static final String DEST = "/Users/haoliu350/Desktop/Timesheet_watermarked2.pdf";
    ...
    public void manipulatePdf(String src, String dest) throws IOException, DocumentException {
        ...
        ColumnText.showTextAligned(under, Element.ALIGN_CENTER, p, 297, 550, 50);
        PdfContentByte over = stamper.getOverContent(1);
        p = new Phrase("This watermark is added ON TOP OF the existing content", f);
        ColumnText.showTextAligned(over, Element.ALIGN_CENTER, p, 297, 500, 30);
